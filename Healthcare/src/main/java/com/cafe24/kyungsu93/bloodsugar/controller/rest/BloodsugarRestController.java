...
public class BloodsugarRestController {
	...
	@RequestMapping(value="/bloodSugarNoCountToHealthScreen", method=RequestMethod.GET)
	@ResponseBody
	public Map<String, Integer> bloodSugarNoCountToHealthScreen(@RequestParam(value="bloodSugarNo") String bloodSugarNo) {
		logger.debug("BloodPressureRestController - bloodPressureNoCountToHealthScreen ajax 실행.");
		Map<String,Integer> resultmap = bloodSugarService.bloodSugarNoCountToHealthScreen(bloodSugarNo);
