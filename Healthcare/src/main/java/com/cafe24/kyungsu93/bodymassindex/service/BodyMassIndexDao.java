...
public class BodyMassIndexDao {
	...
	//체질량 1개 가져오기
	public BodyMassIndex selectBodyMassIndexOne(String bodyMassIndexNo) {
		logger.debug("BodyMassIndexDao.selectBodyMassIndexOne");
		return sqlSession.selectOne(NS + "selectBodyMassIndexOne", bodyMassIndexNo);
	}
